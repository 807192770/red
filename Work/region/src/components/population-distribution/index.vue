<template>
  <div class="population-distribution">
    ...
    <div class="middle">
      ...
      <heat-map @showDanger="showDanger" :data="heatMap" @dateValue="dateValue" />
      <base-bg class="middle-user" :titlename="titlename[6]" @showbigpicture="showbigpicture(6)">
        <line-chart :flag="1" :dataList="numberOfUsers" :height="heightMiddle"/>
      </base-bg>
    </div>
    <div class="right">

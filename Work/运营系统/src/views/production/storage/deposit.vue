            ...
            <el-collapse accordion v-model="activeName">
              <el-collapse-item :name="j" v-for="(item,j) in orderList" :key="j">
                ...
                <el-row class="it-txt" v-for="(it,key) in item.stockList" :key="key" :gutter="40">
                  ...
                  <el-col :span="7">
                    <el-button class="btn" type="primary" size="mini" @click="addRow(j,item,it,key)">复制当前行
                    </el-button>
                    <el-button class="btn" type="danger" size="mini" @click="delRow(item,key)">删除当前行</el-button>
                  </el-col>
                </el-row>

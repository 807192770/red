  ...
  <div class="active-population">
    <div class="left" id="left">
      ...
      <base-bg :titlename="titlename[1]" @showbigpicture="showbigpicture(1)">
        <population-origin :dataList="populationOrigin" :height="height" :flag="1"/>
      </base-bg>
      <base-bg :titlename="titlename[2]" @showbigpicture="showbigpicture(2)">
        <doughnut-chart :dataList="populationType" :height="height" :flag="1"/>
      </base-bg>
    </div>
    <div class="middle">
      <search :dataList="treeList" @regionMes="regionMes" @regionMapMes="regionMapMes" @dateValue="dateValue"/>
      <hunan-map :dataList="mapList" @regionMes="regionMes" @regionMapMes="regionMapMes" :height="heightTotal"/>
      <base-bg :titlename="titlename[6]" @showbigpicture="showbigpicture(6)">
        <line-chart :dataList="activeList" :height="heightLine" :flag="1"/>
      </base-bg>
    </div>
    <div class="right">
      <base-bg :titlename="titlename[3]" @showbigpicture="showbigpicture(3)">
        <population-table :dataList="carList" :flag="1" :height="height"/>
      </base-bg>
      <base-bg :titlename="titlename[4]" @showbigpicture="showbigpicture(4)">
        <bar-chart :dataList="otherProvinces" :flag="1" :height="height"/>
      </base-bg>
      <base-bg :titlename="titlename[5]" @showbigpicture="showbigpicture(5)">
        <provincial-number :dataList="originList" :flag="1" :height="height"/>
      </base-bg>
    </div>
...
import {getActivePopulation} from '../../api/active-population'
...
export default {
  ...
  methods: {
    ...
    getAgeList () {
      ...
      getActivePopulation(params).then(response => {
...
//      console.log(data)
        ...
        this.$store.commit('SET_ORIGIN', originListp)
      })
    },
    getTypeList () {
      var params = {
      ...
      getActivePopulation(params).then(response => {
        ...
        if (data) {
          ...
          this.$store.commit('SET_TYPE', dataReset)
        } else {
...
//      console.log(response.data.data)
    ...
    getPopulationNumber () {
      ...
      getActivePopulation(params).then(response => {
        var data = response.data.data
        this.$store.commit('SET_POPULATIONNUMBER', data)
        // console.log(response.data.data)
      })
    },
    getOtherProvincesList () {
      ...
      getActivePopulation(params).then(response => {
        var data = response.data.data
        this.$store.commit('SET_OTHERPROVINCES', data)
//      console.log(response.data.data)
      })
    },
    getRoamList () {
      ...
      getActivePopulation(params).then(response => {
        var data = response.data.data
        this.$store.commit('SET_ROAM', data)
//      console.log(response.data.data)
      })
    },
    getMapList () {
      ...
      getActivePopulation(params).then(response => {
        ...
        this.$store.commit('SET_MAP', data)
      })
    },
    getChangeList () {
      var params = {
      ...
      getActivePopulation(params).then(response => {
        var data = response.data.data
        this.$store.commit('SET_ACTIVE', data)
//      console.log(response.data.data)
      })
    },
    getTreeList () {
    ...
    showbigpicture (val) {
      ...
      switch (val) {
        ...
        case 1 :
          ...
          this.currentData = this.populationOrigin

<template>
  <div class="app-container">
    <section class="content">
      ...
      <lineInfo :charts-data="currentChart" :field="f_current" child-id="current_chart" :cycle="c_current" />
      <lineInfo :charts-data="volumeChart" :field="f_volume" child-id="volume_chart" :cycle="c_volume" />
      <el-form label-width="100px" size="small">
        <el-row class="list">
          <el-col :span="12" class="item">
            <el-form-item label="分析结果">
              <el-input type="textarea" :rows="4" label="分析结果" placeholder="请输入分析结果" v-model="report.analyze"
                maxlength="200" show-word-limit></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="item">
            <el-form-item label="专家建议">
              <el-input type="textarea" :rows="4" label="专家建议" placeholder="请输入专家建议" v-model="report.expert"
                maxlength="200" show-word-limit></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <el-row>
        <el-col :span="24" class="tr">
          ...
          <el-button type="warning" size="small" @click="releaseReport()">打印</el-button>
        </el-col>
      </el-row>
    </section>
  </div>

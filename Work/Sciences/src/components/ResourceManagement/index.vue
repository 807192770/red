  ...
  <div class="resource-management-index">
    ...
    <div class="main">
      <div class="main-header">
        <div class="left">
          ...
          <el-input
            v-model="keyWords"
            placeholder="请输入员工名称/工牌ID/工号/部门/子部门进行搜索"
            class="left-input"
            size="small"
          >
        ...
        <div class="right">
          ...
          >导出</el-button>
          <el-button type="primary" size="small" @click="edit(null)">新增员工</el-button>
        </div>
      </div>
      <div class="main-content">
        <div class="table-data">
          <el-table class="table" :data="tableData" stripe style="width: 100%" size="mini">
            ...
            <el-table-column prop="id" label="工牌ID"></el-table-column>
            <el-table-column prop="goodsId" label="工号"></el-table-column>
    ...
    <div class="pop">
      ...
      <el-dialog title="导出" :visible.sync="dialogeExport" width="400px">
        <el-radio v-model="exportRadio" label="1">导出人员信息</el-radio>
      ...
      <el-dialog title="新增员工" :visible.sync="dialogeEdit" width="700px">
        <div class="editForm">
          ...
          <el-form :model="editForm" style="width:70%" :rules="rules" ref="editForm">
            <el-form-item label="员工名称：" prop="name" :label-width="formLabelWidth">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: "请填写员工名称", trigger: "blur" }],
  ...
  methods: {
    ...
    deleteData(index, row) {
      this.$confirm(
        "是否要删除此条信息？<p><span>提示：</span>若此员工已绑定设备，会连同设备信息一并删除</p>",
        "删除",
        {
